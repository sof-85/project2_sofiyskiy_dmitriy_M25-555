...
def welcome():
    '''Функция выводит приветствие пользователю и запрашивает ввод команды'''
    import prompt
...
def run():
    '''Функция является основным циклом работы программы'''
    import shlex, core as core, utils as utils
    print_help()
    user_input = ''
